    ...
    return (
        <div className="mt-20">
            ...
            >
                <SwiperSlide>
                <motion.div drag>
                    <div className="bg-black bg-opacity-25 shadow-xl w-[340px] md:w-[600px] flex flex-col md:flex-row justify-between items-center p-5 rounded-3xl ml-20 md:ml-40 lg:ml-72">
                        <div>
